...
public class KingDataSourceConfig {
    ...
    static final String PACKAGE = "org.david.rain.boot.start.dao.mapper.king";
    static final String MAPPER_LOCATION = "classpath:org/david/rain/boot/start/dao/mapper/king/*.xml";
