 ...
 */
@Service()
public class OracleDaoImp implements CommonDao {
    ...
    public int addOrUpdateForTransaction(String sql, String sql1, String sql2,
        ...
        Integer state = -1;
        PlatformTransactionManager manager = oracleTransactionTemplate
        ...
        try {
            for (int i = 0; i < o[1].length; i++) {
                ...
                oracleJdbcTemplate.update(sql, inserto);
            }
            for (int i = 0; i < o[0].length; i++) {
                Object[] inserto = {o[0][i]};
                oracleJdbcTemplate.update(sql1, inserto);
            }
            for (int i = 0; i < userCondition.size(); i++) {
                Object[] inserto = userCondition.get(i).toArray();
                oracleJdbcTemplate.update(sql2, inserto);
            }
        } catch (Exception e) {
    ...
    public int addOrUpdateForTransactionOneTable(String sql, String sqlselect,
        ...
        try {
            for (int i = 0; i < o.length; i++) {
                ...
                Object[] inserto = {o[i]};
                if (oracleJdbcTemplate.queryForObject(sqlselect, inserto,
                        Integer.class) == 0)
                    oracleJdbcTemplate.update(sql, inserto);
            }
        } catch (Exception e) {
    ...
    public int addOrUpdate(String sql, Object[] o) {
        return oracleJdbcTemplate.update(sql, o);
    }

    @Override
    public int queryForInt(String sql, Object[] o) {
        return oracleJdbcTemplate.queryForObject(sql, o, Integer.class);
    }
    ...
    public List queryList(String sql, Object[] o) {
        return oracleJdbcTemplate.queryForList(sql, o);
    }
    ...
    public <T> List<T> queryObjList(String sql, Object[] args,
                                    final Class<T> clazz) {
        return oracleJdbcTemplate.query(sql, args, new RowMapper<T>() {
    ...
    public <T> T queryObj(String sql, Object[] args, final Class<T> clazz) {
        return oracleJdbcTemplate.query(sql, args, new ResultSetExtractor<T>() {
    ...
    public <T> List<T> queryForList(String sql, Object[] args,
                                    Class<T> elementType) {
        return oracleJdbcTemplate.queryForList(sql, args, elementType);
    }
    ...
    public <T> List<T> query(String sql, Object[] args, RowMapper<T> rowMapper) {
        return oracleJdbcTemplate.query(sql, args, rowMapper);
    }

    @Override
    public int[] batchUpdate(String sql, BatchPreparedStatementSetter pss) {
        return oracleJdbcTemplate.batchUpdate(sql, pss);
    }

    @Override
    public void execSql(String sqlString) {
        // TODO Auto-generated method stub
        oracleJdbcTemplate.execute(sqlString);
    }


    @Override
    public List queryInList(String oraQueryListSql, MapSqlParameterSource parameters) {
        return oracleJdbcTemplate.queryForList(oraQueryListSql, parameters);
