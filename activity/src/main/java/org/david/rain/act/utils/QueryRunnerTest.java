 ...
 */
public class QueryRunnerTest extends AbstractQueryRunner {
     ...
     */
    public QueryRunnerTest(boolean pmdKnownBroken) {
     ...
     */
    public QueryRunnerTest(DataSource ds) {
        super(ds);
    }
     ...
     * and if it breaks, we'll remember not to use it again.
     */
    public QueryRunnerTest(DataSource ds, boolean pmdKnownBroken) {
     ...
     * @throws SQLException if a database access error occurs
     * @deprecated Use {@link #query(Connection, String, org.apache.commons.dbutils.ResultSetHandler, Object...)}
     */
    @Deprecated
