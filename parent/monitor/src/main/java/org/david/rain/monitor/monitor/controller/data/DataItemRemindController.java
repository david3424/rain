...
import org.david.rain.monitor.monitor.service.data.DataRemindService;
...
@Controller
@RequestMapping("/data/item/remind")
public class DataItemRemindController {

    static Logger logger = LoggerFactory.getLogger(DataItemRemindController.class);


    @Autowired
    DataRemindService remindService;
