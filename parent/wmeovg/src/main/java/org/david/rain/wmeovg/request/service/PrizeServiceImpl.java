...
*//*
		...
		NameValuePair[] params = {
				...
				new NameValuePair("rolename", prizeBean.getRolename()),
...
//		return statusCode;
	...
	public int send(String gid, Integer zoneid, String account,
			String rolename, Long roleid, Integer prizeid, String callback) {
		PrizeBean prizeBean = null;
		try {
			prizeBean = new PrizeBean(gid, zoneid, account, rolename, roleid, prizeid, callback);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public int send(String gid, Integer zoneid, String account,
			String rolename, Long roleid, Integer prizeid, Integer count, Priority priority,
			String callback) {
		
		PrizeBean prizeBean = null;
		try {
			prizeBean = new PrizeBean(gid, zoneid, account, rolename, roleid, prizeid,
					count, priority, callback);
		} catch (Exception e) {
			e.printStackTrace();
			//log.error("虚拟物品兑换系统：兑换请求生成错误");
		}
