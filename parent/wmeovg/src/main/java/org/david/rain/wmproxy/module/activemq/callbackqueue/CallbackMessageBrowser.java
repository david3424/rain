 ...
 * @Description 回调消息队列查看器
 * @version 1.0
 * @date 2010-8-11 上午11:17:30
 */
public class CallbackMessageBrowser {
	...
	public int getCount(String cid) {
		...
		try{
			...
			template.browseSelected(destination, "cid='" + cid + "'", new BrowserCallback() {
	...
	public int getCount(String cid, String appid, Integer prizeid) {
		...
		try{
			...
			template.browseSelected(destination, "cid='" + cid + "' and appid='" + appid + "' and prizeid=" + prizeid, new BrowserCallback() {
