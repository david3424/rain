...
// Source File Name:   PrizeServiceImpl.java
...
import com.wanmei.wmeovg.request.hessian.IPrizeWebService;
import com.wanmei.wmeovg.request.util.Priority;
import com.wanmei.wmeovg.request.util.SignatureUtil;
import com.wanmei.wmeovg.request.util.WmeovgProperties;
...
// Referenced classes of package com.wanmei.wmeovg.request.service:
//			IPrizeService

public final class PrizeServiceImpl
	implements IPrizeService
{

	private static String cid = WmeovgProperties.getCid();
	private static String serverUrl;
	private static String keystorePath;
	private static String keystorePwd;
	private static String privateKey = WmeovgProperties.getPrivateKey();
    ...
    public int sendByRoleIdWithTitleAndContent(String appid, String gid, Integer zoneid, String account, Long roleid, Integer prizeid, String callback, String title, String content) {
        int count = 1;
        Priority priority = Priority.NORMAL;
        return commonSend(appid, gid, zoneid, account, null, roleid, prizeid, Integer.valueOf(count), priority, callback, Byte.valueOf((byte)3));
    }
			...
			Integer count, Priority priority, String callback, Byte prizeSendType)
	{
		...
		try
		{
			...
			case 2: // '\002'
				...
				break;
            case 3: // '\003'
				rtn = prizeWebService.sendByRoleIdWithTitleAndContent(cid, appid, gid, zoneid, account, prizeBean.getRoleid(), prizeid, count, Byte.valueOf((byte)prizeBean.getPriority().ordinal()), prizeBean.getCallback(), sign, ip,"system","");
				break;
