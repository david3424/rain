 ...
 * Time: 上午11:44
 */
@Qualifier("prize161DaoImp")
@Repository
public class Prize161DaoImp implements Idao {
    protected QueryRunner runner;
    protected DataSource dataSource161;
    private static final Log LOG = LogFactory.getLog(Prize161DaoImp.class);

    @Autowired
    public void setdataSource161(@Qualifier("dataSource161") DataSource dataSource161) {
        this.dataSource161 = dataSource161;
        this.runner = new QueryRunner(dataSource161);
    }
