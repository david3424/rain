...
<body>
<form action="hksend3.jsp" method="post">
<table>
	<tr>
		<td>应用标识</td>
	...
	<tr>
		<td>角色ID（梦珠）</td>
		<td><input type='text' name='roleid' value="1000000" /></td>
	</tr>
	<tr>
		<td>奖品ID</td>
...
<%
	...
	if (pid != null) {
		...
		int rtn = prizeService.sendByRoleId(appid, gid, zoneid, account,
                Integer.valueOf(roleid),  prizeid, callback);
