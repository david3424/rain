...
<%@ page import="com.david.web.wanmei.util.msm.MemcachedSessionManager" %>
<%--
...
<script type="text/javascript" src="${ctx}/extend/testwmpassport/wanmei.passport.js"></script>
<body>
...
<%
	...
	MemcachedSessionManager manager = webApplicationContext.getBean("memcachedSessionManager",MemcachedSessionManager.class);
