...
public class LotteryDemoService {
    ...
    static {
        ...
        dateMap.put("2016-03-16", 0);
        dateMap.put("2016-03-18", 1);
        dateMap.put("2016-03-19", 2);
        dateMap.put("2016-03-20", 3);
        dateMap.put("2016-03-21", 4);
        dateMap.put("2016-03-22", 5);
        dateMap.put("2016-03-23", 6);
        dateMap.put("2016-03-24", 7);
        dateMap.put("2016-03-25", 8);
        dateMap.put("2016-03-26", 9);
        dateMap.put("2016-03-27", 10);
        dateMap.put("2016-03-28", 11);
        dateMap.put("2016-03-29", 12);
        dateMap.put("2016-03-30", 13);
        dateMap.put("2016-03-31", 14);
        dateMap.put("2016-03-01", 15);
...
//            抽奖次数+1
     ...
     * @throws SQLException
     */
    public Map savePrize(LotteryPrize prize) throws SQLException {
        int rtn = dao.insert(prize);
        if (rtn <= 0) {
            throw new RuntimeException("网络中断,稍后重试!");
        }
        return ObjectResponseWrapper.commonResponse(true, 1, "恭喜您中了" + prize.getPrizeName());
    }
    /**
     * 获取当前可抽奖次数
     *
