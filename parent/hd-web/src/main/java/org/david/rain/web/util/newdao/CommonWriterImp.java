package org.david.rain.web.util.newdao;
...
import org.david.rain.common.repository.QueryNewRunner;
import org.david.rain.common.repository.SqlResolver;
...
public class CommonWriterImp implements Idao {
    ...
    public Number insertAndGetIntegerId(Object object) throws SQLException {
        insert(object);
        String sql = "select last_insert_id() ";
    ...
    public Map<String ,Object> queryLineMap(String sql, Object... paramValues) throws SQLException {

        ResultSetHandler handler = new MapHandler();
        return (Map) runner.query(sql,handler,paramValues);
    }
     ...
     * @throws java.sql.SQLException
     */
    public List<Map<String, Object>> queryMapColumnList(String sql,Object... paramValues) throws SQLException {

        return runner.query(sql,new MapListHandler(),paramValues);
    }

    public List<Map<String, Object>> queryMapColumnList(String sql) throws SQLException {

        return queryMapColumnList(sql,(Object[]) null);
    }
}
