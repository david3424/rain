...
*  北京完美时空网络技术有限公司
*/
package org.david.rain.pay.client.dao.dbutils.search;
...
public class Search {
    ...
    // 当前表中一个查询的where部分的集合；
    public Map<String, Where> whereMap = new HashMap<>();
   ...
   public boolean isFlag() {
    ...
    //存放?对应的参数。
    private List<Object> whereParas = new ArrayList<>();
...
//        if (request != null) request.setAttribute("search", this);
    ...
    public Map<String, Where> getWhereMap() {
        return whereMap;
    }

    public void setWhereMap(Map<String, Where> whereMap) {
