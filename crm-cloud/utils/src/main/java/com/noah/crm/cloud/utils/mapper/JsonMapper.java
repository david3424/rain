 ...
 *******************************************************************************/
package com.noah.crm.cloud.utils.mapper;
...
public class JsonMapper {
    ...
    public JsonMapper(Include include, boolean isCapitalProperties) {
        mapper = new ObjectMapper();
        // 设置输出时包含属性的风格
        if (include != null) {
            mapper.setSerializationInclusion(include);
        }
        if (isCapitalProperties) {
            mapper.setPropertyNamingStrategy(new PropertyNamingStrategy() {
                ...
                public String nameForSetterMethod(MapperConfig<?> config,
                    ...
                    return defaultName.contains("_") ? StringUtils.capitalize(defaultName) : defaultName;
                }
                ...
                public String nameForGetterMethod(MapperConfig<?> config,
                                                  AnnotatedMethod method, String defaultName) {
                    String nameForSetter = defaultName.contains("_") ? StringUtils.capitalize(defaultName) : defaultName;
     ...
     */
    public static JsonMapper firstCaptalMapper() {

        return new JsonMapper(null, true);
    }
