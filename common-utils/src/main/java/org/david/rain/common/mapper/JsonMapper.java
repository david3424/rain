...
import org.david.rain.common.base.annotation.Nullable;
        ...
        if (isCapitalProperties) {
            mapper.setPropertyNamingStrategy(new PropertyNamingStrategy() {
                ...
                public String nameForSetterMethod(MapperConfig<?> config,
                    ...
                    String nameForSetter = defaultName.contains("_") ? StringUtil.capitalize(defaultName) : defaultName;
                    LoggerUtil.info("properties name is {}", nameForSetter);
